...
namespace AnalogSignalAnalysisWpf.Hardware.Scope
{
    internal class MyDLLimport
    {
        ...
        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Auto)]
        public static extern int CLearBuffer(char obj, uint num);
        ...
        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int DataPreDisposal(uint type, uint start, uint count, bool phaseLock);

        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int AlignEquivalentData(uint type, int start, uint count);

        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int CompleteEquivalentData(uint type, int start, uint count);

        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern IntPtr GetEquivalentData4Read(int index);

        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int EquivalentDataDisposal(uint type, int start, uint count);
        ...
        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void SpecifyDevIdx(int index);

        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern int VerifyDev(IntPtr index);
        ...
        [DllImport("USBInterFace.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern void SetAfterGlow(bool b);
    }
}
